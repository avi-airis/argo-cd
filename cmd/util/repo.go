...
func AddRepoFlags(command *cobra.Command, opts *RepoOptions) {
	...
	command.Flags().BoolVar(&opts.UseGCPWorkloadIdentity, "use-gcp-workload-identity", false, "whether to use gcp workload identity for authentication")
